...
GENERATED_KOTLIN="app/build/generated/sherpa/kotlin"
JNI_DIR="app/src/main/jniLibs"
ASSET_DIR="app/src/main/assets/${MODEL_NAME}"
...
git clone --depth 1 --branch "${SHERPA_VERSION}" \
  https://github.com/k2-fsa/sherpa-onnx.git "${WORK_DIR}/source"
...
cat > "${ASSET_DIR}/keywords.txt" <<'EOF'
▁HE Y ▁I C AR US :1.8 #0.30 @HEY_ICARUS
EOF
